...
public class Enemigos2 extends ObjetoQueSemueve{
    private Cronometro cronometro = new Cronometro();
    private int movimiento ; 
    private ReproductorSonidos sonidoAplastar;

    public Enemigos2(Vector2D posicion, BufferedImage textura, EstadoDeJuego estadoDeJuego, BufferedImage[] texturaArray, Nivel nivel){
